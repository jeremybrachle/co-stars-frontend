...
const DEMO_SNAPSHOT: FrontendSnapshot = {
	meta: {
		...
		levelGroupCount: DEMO_MANIFEST.levelGroupCount,
		normalGameCount: DEMO_MANIFEST.normalGameCount,
		bossGameCount: DEMO_MANIFEST.bossGameCount,
		levelSchemaVersion: DEMO_MANIFEST.levelSchemaVersion,
	},
	actors: [
	...
	levels: [
		{
			...
			games: [
				{
					levelGroupId: "demo-1",
					levelGroupName: "Starter Pack",
					gameId: "1",
					gameType: "normal-non-boss",
					startNode: { id: 1, type: "actor", label: "George Clooney" },
					targetNode: { id: 2, type: "actor", label: "Brad Pitt" },
					notes: { text: "Offline demo pairing." },
					settings: {},
				},
				{
					levelGroupId: "demo-1",
					...
					gameId: "2",
					gameType: "normal-non-boss",
					startNode: { id: 5, type: "actor", label: "Sandra Bullock" },
					targetNode: { id: 6, type: "actor", label: "Keanu Reeves" },
					notes: { text: "Offline demo pairing." },
					settings: {},
				},
				{
					...
					gameType: "normal-non-boss",
					startNode: { id: 1, type: "actor", label: "George Clooney" },
					targetNode: { id: 3, type: "actor", label: "Julia Roberts" },
					notes: { text: "Offline demo pairing." },
					settings: {},
				},
			],
		...
		{
			levelId: "demo-2",
			levelName: "Crossovers",
			games: [
				{
					levelGroupId: "demo-2",
					levelGroupName: "Crossovers",
					gameId: "1",
					gameType: "normal-non-boss",
					startNode: { id: 7, type: "actor", label: "Carrie-Anne Moss" },
					targetNode: { id: 6, type: "actor", label: "Keanu Reeves" },
					notes: { text: "Offline demo pairing." },
					settings: {},
				},
				{
					...
					gameId: "2",
					gameType: "normal-non-boss",
					startNode: { id: 4, type: "actor", label: "Matt Damon" },
					targetNode: { id: 3, type: "actor", label: "Julia Roberts" },
					notes: { text: "Offline demo pairing." },
					settings: {},
				},
				{
					...
					gameId: "3",
					gameType: "normal-non-boss",
					startNode: { id: 8, type: "actor", label: "Hugo Weaving" },
					targetNode: { id: 5, type: "actor", label: "Sandra Bullock" },
					notes: { text: "Offline demo pairing." },
					settings: {},
				},
			],
